...
def Get_Label(Speichern=0):
    ...
    Ordner = r'C:\Users\corvi\OneDrive - stud.tu-darmstadt.de\Desktop\Masterthesis\10_Daten_Versuche' #Hier entsprechenden Ordner Pfad, in der die Datei Labels liegt eingeben
    Datei = 'Labels_KurzesBlech.csv' #Name der Excel Datei
    ...
    # Wird benötigt um die CSV richtig zu erstellen, ansonsten ersetzt er die 3.5 zu 3.Mai #Für die weitere Verwendung muss es auskommentiert werden
        ...
        Labels.to_csv(f'{Ordner}\Labels_Angepasst_KurzesBlech.csv', index=False, sep=';') # Umgerechnete Labels werden in eine neue Excel geladen, am gleichen Ort an dem die vorherige Datei Labels gespeichert ist
